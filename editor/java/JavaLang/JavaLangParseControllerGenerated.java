...
public class JavaLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("JavaLang");
  ...
  { 
    JavaLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = JavaLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = JavaLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(JavaLangParseControllerGenerated.class);
    }
  ...
  { 
    return JavaLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
